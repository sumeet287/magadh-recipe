          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="space-y-6">
              ...
              <p className="text-slate-700 dark:text-slate-200">
                ...
                promotes Bihar&apos;s traditional crafts while empowering local
                artisans through fair trade practices and global market access.
              </p>
            ...
            <div className="space-y-6">
              ...
              <p className="text-slate-700 dark:text-slate-200">
                ...
                recognized and celebrated globally, ensuring the preservation of
