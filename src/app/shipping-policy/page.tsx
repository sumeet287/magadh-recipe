    ...
    <>
      ...
      <PolicyLayout title="Shipping Policy" lastUpdated="May 1, 2025">
        ...
        <p className="text-sm text-gray-600 italic">
          * Delivery times may vary, especially during peak periods or
        ...
        <p>
          ...
          For certain remote areas, additional shipping charges may apply. We
          will contact you before processing your order if there are any
          additional charges.
        </p>
        ...
        <p>
          If your package arrives damaged, please contact us immediately. We
          will work with you to ensure a satisfactory resolution. We may require
          photos or other documentation of the damaged items.
        </p>
        ...
        <p>
          We currently do not offer international shipping. We hope to expand
          our shipping services to more countries in the future.
        </p>
